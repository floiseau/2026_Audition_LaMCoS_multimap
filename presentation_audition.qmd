...
[Moins pratiqué conception mécanique et procédés récemment MAIS longue formation depuis la STI2D]{.alert}

[Investissement dans les formations proposés + suivi des TD/TP des autres membres de l'équipe pédagogique]{.alert}
:::
:::{.column width=30%}
...
|-------|-------------------------------------------------------|-------------------------|
| 1ère  | MS100 - Mécanique des milieux continus                | Formation + Recherche   |
...
Comment concevoir et réaliser une liaison encastrement démontable entre l’écran et le boîtier d’un smartphone ? <br>
Niveau Licence 2 <br>
Enseignement de 8 heures

Illustration de solution techniques

## Notes

- Pré-requis (lien avec les modules de la formation) = contenus mobilisés ?
- Objectifs visés
- Démarche pédagogique retenue.
